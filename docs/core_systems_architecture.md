...
Version 0.7.9 formalizes the **Platform Specification** and granular bootstrap sequence, establishes a stable handshake between the kernel and the language runtime, and introduces **Capability-First VFS** and **Asynchronous Supervision**.
